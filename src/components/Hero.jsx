        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                 <div className="flex flex-col items-center lg:items-start">
                    ...
                    initial="hidden"
                    animate="visible"
                    className="my-2 max-w-xl py-6 font-light font:arial tracking-tighter">{HERO_CONTENT}</motion.p>  
                    ...
                    <a href="https://drive.google.com/file/d/1TkqDoRfPbG3xAJZOvJl5J4zQiVPABKWh/view?usp=drive_link" target="blank"> 
            ...
            <div className="flex justify-center">
              ...
              src={profilePic} alt="Sachin Kr Singh"></motion.img>
              </div>
              </div>
        </div>
    </div>
